...
import os
from modules.utility import csv_to_dataframe
from modules.utility import clean_timestamp
from modules.utility import resample
...
stock_path = os.path.join(current_dir, "..", "resources", "Stock_Data", "Daily")
fred_daily = os.path.join(current_dir, "..", "resources", "FRED_Data", "Daily")
fred_weekly = os.path.join(current_dir, "..", "resources", "FRED_Data", "Weekly")
fred_monthly = os.path.join(current_dir, "..", "resources", "FRED_Data", "Monthly")
fred_quarterly = os.path.join(current_dir, "..", "resources", "FRED_Data", "Quarterly")
...
columns_to_drop = [col for col in analysis_dropped_categories if col in stock_close_analysis_df.columns]

# Drop the columns
stock_close_analysis_df = stock_close_analysis_df.drop(columns=columns_to_drop)
